...
urlpatterns = [
    ...
    url('assign/',include('assign.url')),
    url('complaint/',include('complaint.url')),
    url('counsellor/',include('counsellor.url')),
    url('feedback/',include('feedback.url')),
    url('login/',include('login.url')),
    url('task/',include('task.url')),
    url('user/',include('user.url')),
    url('extracular/',include('extracular.url')),
